export const historyData = {
    title: "Our History",
    subtitle: "From a local burden in Morelia to an international movement reaching the nations with the light of the Gospel.",
    
    // Imagen de encabezado: Un paisaje de México o algo inspirador
    headerImage: "https://images.unsplash.com/photo-1518105779142-d975f22f1b0a?q=80&w=2070&auto=format&fit=crop",
    ...
    meaning: {
        ...
        // El cuerpo del texto
        description: "As believers we are called to be lights in the world for the glory of God.",
        // El versículo clave
        bibleVerse: "that you may become blameless and harmless, children of God without fault in the midst of a crooked and perverse generation, among whom you shine as lights in the world.",
        bibleReference: "Philippians 2:15"
    },
