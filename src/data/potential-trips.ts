// src/data/potential-trips.ts

export const potentialTripsData = {
    title: "Potential Trips",
    subtitle: "Step out of your comfort zone and join us on the field. The harvest is plentiful, but the laborers are few.",
    headerImage: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?q=80&w=2074&auto=format&fit=crop",

    intro: {
        title: "Why Go?",
        description: [
            "Missions trips are a powerful way for churches to get involved in the work of Lampei while providing opportunities for believers to move beyond their comfort zones, use their spiritual gifts, and help further the Gospel in new areas.",
            "Lampei seeks to reach the nations through church planting, leadership development, and education. For this reason the ministry options are plentiful. Examples include: sports camps, vacation Bible school, open concerts, medical missions, door-to-door evangelism, open air evangelism, and teaching Pastors.",
    ...
    destinations: [
        {
            ...
            // CORREGIDO: Link funcional y verificado
            image: "https://images.unsplash.com/photo-1512813588311-54bc9fcc4ec8?q=80&w=800", 
            videoId: "3Idu0Ly3cKQ",
        ...
        },
        {
            ...
            // CORREGIDO: Link funcional y verificado para montañas/naturaleza
        ...
        },
        {
            ...
            // CORREGIDO: Se añade '/' inicial para asegurar la ruta desde la carpeta public
            image: "/chile.jpg", 
            videoId: "",
