export const heroData = {
    // AHORA SÍ: El nombre completo como protagonista
    title: "Lampei International",
    titleHighlight: "Ministries", 
    
    // Subtítulo con la misión (En Inglés)
    description: "Reaching the nations with the light of the Gospel through church planting, leadership development, and biblical education.",
    ...
    // NUEVA IMAGEN: Un mapa mundial oscuro y elegante (Unsplash)
    // Esto dará ese toque "Internacional" que buscamos sin usar la imagen borrosa de Wix.
...
export const pillarsData = [
    ...
    {
        quote: "Prior to becoming a college president, I spent many years planting churches in difficult places. I have known hundreds, if not thousands, who have responded to the need to fulfill the Great Commission of our Lord Jesus through planting churches. Quite frankly most who set out to do so quit within the first 18 months. However, the leaders of Lampei International Ministries stand the test of time and have a proven track record of not just talking about church planting but actually planting churches that are making a difference for eternity.",
